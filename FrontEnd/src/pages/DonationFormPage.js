...
//     // Here you would send data to backend with axios/fetch
//     alert(`Thank you for donating ${donationType}!`);
//     navigate('/');
//   };
...
//         <input type="text" placeholder="Your Name" required={!isAnonymous} disabled={isAnonymous} />
//         <input type="email" placeholder="Your Email" required={!isAnonymous} disabled={isAnonymous} />
...
//         <label><strong>Choose Donation Type:</strong></label>
...
//             <input type="text" placeholder="Payment Method (UPI, Card...)" required />
//             <input type="text" placeholder="Transaction ID" required />
//           </>
//         )}
//         {donationType !== "money" && (
//           <input type="text" placeholder={`Details about ${donationType}`} required />
//         )}
